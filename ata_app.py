    ...
    for line_no, raw in enumerate(code.splitlines(), start=1):
        ...
        if line.startswith("yaz "):
            ...
            try:
                ...
                raise Exception(f"Satır {line_no}: 'tekrar' kullanımı hatalı")
...
# =============================
root = tk.Tk()
root.title("ATA Language – Desktop IDE")
...
editor = tk.Text(frame, bg="#1e1e1e", fg="#ffffff",
...
output_box = tk.Text(root, height=10, bg="#000000", fg="#00ff88",
                     font=("Consolas", 11))
